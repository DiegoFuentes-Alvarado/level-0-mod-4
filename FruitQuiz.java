...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		// 11. Make another question called "question2". Use question1 above as
		// a guide.
		question2 = new JLabel(
				"<html>Which is not a berry? <br> A: Blueberry <br> B: Banana <br> C: Strawberryb</html>");
	...
	public void keyPressed(KeyEvent arg0) {
		...
		// IMPORTANT: The questions must be in reverse order from top to bottom
		// to work properly
